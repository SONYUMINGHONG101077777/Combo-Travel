  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-orange-500 hover:bg-blue-600 text-white px-4 py-1 rounded-100">
          MORE
        </Button>
      </DialogTrigger>

      <DialogContent className="sm:max-w-[600px] bg-white rounded-xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
