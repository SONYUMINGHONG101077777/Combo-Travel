...
const Home = () => {
  ...
  const places = [
    ...
    },
    {
      ...
      img: "https://media.timeout.com/images/105239239/image.jpg"
    },
    {
      title: "កោះសាម្លូត",
    ...
    },
    {
      ...
      img: "https://image.freshnewsasia.com/2021/id-022/fn-2024-08-03-22-09-57-5.jpg"
    },
    {
      title: "ផ្កាព្រៃរីស៊ត",
    ...
    },
    {
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7UvjHNKL_p3gF0PCon50ickOOXUqgzEnZ8hhrL6x3whBUP0tRr0GEpQd9FXQIa0LY05Q&usqp=CAU"
    },
    {
      title: "កោះគុងក្រៅ",
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShb1n8pdeR4APjjO06LwuJAtrdEWD07Fd-MlLGOleJUqPS4MOQfhK6bAqhVP32XdBU-lE&usqp=CAU"
    },
    {
      title: "មណ្ឌលគិរី",
    ...
    {
      title: "ប្រាសាទកោះគេរ្ត៍",
      description: "កោះប្រាសាទកោះគេរ្ត៍ (Koh Ker Temple Complex) ស្ថិតនៅក្នុងស្រុកគូលែន ខេត្តព្រះវិហារ ប្រហែលជា ១២០ គីឡូម៉ែត្រពីទីក្រុងសៀមរាប។ វាជាទីតាំងប្រវត្តិសាស្ត្រមានតម្លៃខ្ពស់ ដែលធ្លាប់ជារាជធានីបណ្តោះអាសន្ននៃអាណាចក្រខ្មែរ ក្នុងរាជកាលព្រះបាទជយាវរ្ម័នទី ៤ (ជុំវិញឆ្នាំ ៩២៨–៩៤៤ ស.គ.)។ធម្មជាតិស្រស់ស្អាត មានទេសភាពភ្នំសមុទ្រចម្រង់គ្នា។",
      img: "https://www.cnc.com.kh/news/3d049912952a9cb135be69a4d1bff3d4.jpg"
    }
    ,{
      title: "ប្រាសាទតាមាន់",
  ...
  return (
    <div>
      ...
      <section className="py-10 px-6 bg-gray-50">
        ...
        {/* ✅ Responsive for all: iPhone 14 Pro Max & 16 Pro Max → 1 column */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {places.map((place, index) => (
            <div
              key={index}
              className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-transform hover:scale-105 duration-300"
            >
              <img
                src={place.img}
                alt={place.title}
